...
@router.get(f"{API_ROOT}/ping", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/frames/count", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/keograms/by_id_night/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/nights/count", tags=[ApiTags.Database])
def get_nights_count(db: Session = Depends(get_db)):
    return {"count": db.query(Nights).count()}



@router.get(f"{API_ROOT}/backgrounds/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/backgrounds/by_date/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/backgrounds/by_id_night/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/backgrounds/count", tags=[ApiTags.Database])
def get_backgrounds_count(db: Session = Depends(get_db)):
    return {"count": db.query(Background).count()}



@router.get(f"{API_ROOT}/backgrounds_all/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/backgrounds_all/by_date/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/backgrounds_all/by_id_night/", tags=[ApiTags.Database])
...
@router.get(f"{API_ROOT}/backgrounds_all/count", tags=[ApiTags.Database])
