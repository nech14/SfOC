...
def print_SLIC_DBSCAN(names_files, new_path, i, type_fits=FitsInfo2014, _zip=False, one_fig=True):
...
def SLIC_DBSCAN(names_files, new_path, i, percent_to_trim=0.1, type_fits=FitsInfo2014, _zip=False, return_img=False,
...
def print_diff_canny(names_files, new_path, i, eps=10, min_samples=5, _resize=True, show=False, suptitle=None,
                         type_fits=FitsInfo2014, save_folder=None, nameFile="img", file_name=None):
...
def canny_frame_best(names_files, new_path, i, percent_to_trim=0.1, _zip=False, type_fits=FitsInfo2014, save_folder=None,
...
def canny_frame(names_files, new_path, i, percent_to_trim=0.1, _zip=False, type_fits=FitsInfo2014,
...
def bin_frame_best(names_files, new_path, i, percent_to_trim=0.1, _zip=False, type_fits=FitsInfo2014, save_folder=None,
...
def bin_frame(names_files, new_path, i, percent_to_trim=0.1, _zip=False, type_fits=FitsInfo2014, save_folder=None,
...
def work_with_date(names_files, new_path, i, percent_to_trim=0.1, _zip=False, type_fits=file.FitsInfo):
    ...
    data = old_graphics.cut_img(data, percent_to_trim, nan=False)
    data1 = old_graphics.cut_img(data1, percent_to_trim, nan=False)
