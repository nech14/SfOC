...
from src.utils.file import get_name_files
from src.utils.logics.old_logicks import get_dark_AVG, subtract_noise_frame
...
class DarkCommand(BaseCommand):
    ...
    def __init__(
            ...
            file_name = "DARK",
            _zip = False,
            fit_format: FitsInfoAbstract = FitsInfo
    ):
